...
GAME_C_FILES = font.c name.c run.c io.c map.c palette.c edit.c edit-properties.c go.c \
    save.c fill.c tiles.c sprites.c chiptune.c verse.c instrument.c anthem.c main.c
GAME_H_FILES = font.h name.h run.h io.h map.h palette.h edit.h edit-properties.h go.h \
